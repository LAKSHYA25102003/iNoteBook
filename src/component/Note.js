            ...
            >
                ...
                <form className='my-3'>
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="etitle" name='title' aria-describedby="emailHelp" onChange={onChange} />
                    </div>
                    <div className="form-group">
                    ...
                    <button type="submit" className="btn btn-dark" onClick={handleUpdate} >Update</button>
